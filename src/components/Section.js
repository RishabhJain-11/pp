...
const Section = () => {
  return (
      <section className="flex justify-center items-center min-h-screen bg-black">
          <div className="max-w-screen-xl bg-black px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
              <div
              ...
              >
                  ...
                  >
                      <h2 className="text-3xl text-white font-bold sm:text-4xl">Find your career path</h2>
